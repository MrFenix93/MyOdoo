        ...
        for rec in self:
            ...
            # =====================================================
                ...
                lines.append(
                    (0, 0, {
                        "account_id": debit_account.id,
                        "debit": _to_company(rec.amount),
                        "credit": 0.0,
                        "name": seq_name,
                        **_cur_vals(rec.amount),
                    })
                )
                    ...
                    for al in allocations:
                        lines.append(
                            (0, 0, {
                                ...
                                "partner_id": rec.partner_id.id,
                                "credit": _to_company(al.amount_to_collect),
                                "debit": 0.0,
                                "name": seq_name,
                                **_cur_vals(-al.amount_to_collect),
                            })
                        )
